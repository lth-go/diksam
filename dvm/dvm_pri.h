...
typedef enum { NATIVE_FUNCTION, DIKSAM_FUNCTION } FunctionKind;
...
typedef enum { STRING_OBJECT = 1, OBJECT_TYPE_COUNT_PLUS_1 } ObjectType;
...
/* heap.c */
DVM_Object *dvm_literal_to_dvm_string_i(DVM_VirtualMachine *inter,
                                        DVM_Char *str);
