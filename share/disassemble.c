...
static void dump_constant_pool(int constant_pool_count,
...
static void dump_parameter_list(int parameter_count,
                                DVM_LocalVariable *parameter_list) {
    int i;
...
static void dump_variable(int global_variable_count,
...
static void dump_function(int function_count, DVM_Function *function) {
    ...
    for (i = 0; i < function_count; i++) {
        ...
        dump_parameter_list(function[i].parameter_count, function[i].parameter);
        printf("\n");
