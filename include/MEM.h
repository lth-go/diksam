...
void MEM_check_block_func(MEM_Controller controller, char *filename, int line,
                          void *p);
void MEM_check_all_blocks_func(MEM_Controller controller, char *filename,
                               int line);
...
#define MEM_open_storage(page_size)                                    \
    (MEM_open_storage_func(MEM_CURRENT_CONTROLLER, __FILE__, __LINE__, \
                           page_size))
#define MEM_storage_malloc(storage, size)                                \
    (MEM_storage_malloc_func(MEM_CURRENT_CONTROLLER, __FILE__, __LINE__, \
                             storage, size))
